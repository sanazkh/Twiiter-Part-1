...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if(User.current != nil){
            ...
            let homeTimelineViewController = storyboard.instantiateViewController(withIdentifier: "here")
            window?.rootViewController = homeTimelineViewController
        }else{
            let storyboard1 = UIStoryboard(name: "Main", bundle: nil)
            let loginViewController = storyboard1.instantiateViewController(withIdentifier: "LoginViewController")
